...
namespace ed {
	...
	void DebugBreakpointListUI::Update(float delta)
	{
		...
		if (ImGui::BeginTable("##breakpoints_tbl", 4, ImGuiTableFlags_Resizable | ImGuiTableFlags_ScrollY, ImVec2(0, Settings::Instance().CalculateSize(-ImGui::GetFontSize() - 10.0f)))) {
